...
@interface MasatamiTableViewCell()
...
@end
@implementation MasatamiTableViewCell
...
{
    static NSString *identifierNormal = @"MasatamiTableViewCell";
    MasatamiTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifierNormal];
    if (!cell) {
        NSArray *nibs = [[NSBundle mainBundle]loadNibNamed:@"MasatamiTableViewCell" owner:nil options:nil];
